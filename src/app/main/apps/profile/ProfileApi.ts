...
export type GetProfilePhotosVideosApiResponse =
  /** status 200 OK */ ProfilePhotosVideos[];
export type GetProfilePhotosVideosApiArg = void;

export type GetProfileTimelineApiResponse =
  /** status 200 OK */ ProfileTimeline;
