...
import { Button, Divider, Dialog, DialogActions, DialogContent, InputAdornment, TextField } from '@mui/material';
...
function AccountTab() {
	...
	const fetchProfileImageFromS3 = async (key: string): Promise<string | null> => {
		try {
