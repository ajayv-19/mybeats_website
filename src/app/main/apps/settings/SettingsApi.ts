  ...
  .injectEndpoints({
    endpoints: (build) => ({
      getAccountSettings: build.query<
        GetAccountSettingsApiResponse,
        GetAccountSettingsApiArg
      >({
        query: () => ({ url: `/mock-api/settings/account` }),
        providesTags: ["settings_account"],
      }),
      updateAccountSettings: build.mutation<
        UpdateAccountSettingsApiResponse,
        UpdateAccountSettingsApiArg
      >({
        query: (queryArg) => ({
      ...
      getSecuritySettings: build.query<
        GetSecuritySettingsApiResponse,
        GetSecuritySettingsApiArg
      >({
        query: () => ({ url: `/mock-api/settings/security` }),
        providesTags: ["settings_security"],
      }),
      updateSecuritySettings: build.mutation<
        UpdateSecuritySettingsApiResponse,
        UpdateSecuritySettingsApiArg
      >({
        query: (queryArg) => ({
      ...
      getPlanBillingSettings: build.query<
        GetPlanBillingSettingsApiResponse,
        GetPlanBillingSettingsApiArg
      >({
...
export type GetAccountSettingsApiResponse =
  /** status 200 OK */ SettingsAccount;
...
export type GetNotificationSettingsApiResponse =
  /** status 200 OK */ SettingsNotifications;
...
export type GetSecuritySettingsApiResponse =
  /** status 200 OK */ SettingsSecurity;
...
export type GetPlanBillingSettingsApiResponse =
  /** status 200 OK */ SettingsPlanBilling;
...
export type GetTeamMembersSettingsApiResponse =
  /** status 200 OK */ SettingsTeamMember[];
