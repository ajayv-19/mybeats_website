...
function FuseNavigationDoc() {
  ...
  return (
    <>
      ...
      <Typography className="text-15 mt-16 mb-10 font-700" variant="h6">
        [navigation]
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        You can use <b>{`checkPermission={true}`}</b> to enable authorization
        for navigation.
      </Typography>

      <Typography className="text-2xl mt-20 mb-10 font-700" variant="h5">
        Usage
      </Typography>
      ...
      <Typography className="text-2xl mt-24 mb-8 font-medium" component="h2">
        end: bool
      </Typography>
      <Typography className="text-15 mb-8" component="h2">
      ...
      <div className="border-1 rounded-xl p-16 my-16">
        <Typography className="text-15 mb-24" component="h2">
      ...
      <div className="border-1 rounded-xl p-16 my-16">
        <Typography className="text-15 mb-24" component="h2">
          With clicking the button below, a badge will be added into the
          'Project' dashboard navigation item.
        </Typography>
