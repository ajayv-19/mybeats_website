...
// Census county population API disabled — see CENSUS_POPULATION_API.md to re-enable.
// const {
...
class AnalysisController {
   ...
   * DISABLED — full implementation preserved below; see CENSUS_POPULATION_API.md
   */
